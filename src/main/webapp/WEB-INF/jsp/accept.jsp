					...
					<div class="pages" align="center" id="insert">
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<c:forEach items="${session.lis}" var="mail">
								<c:if test="${mail.sign==0}">
									<tr>
										<td align="center" width="15%" height="40px"><a href="${pageContext.request.contextPath}/mail/madetails?id=${mail.id}&state=1">${mail.name}</a></td>
										...
										<td align="center" width="15%"><a href="#"
											onclick="remove(${mail.id})">删除</a></td>
									</tr>
								</c:if>
							</c:forEach>
						</table>
...
<script type="text/javascript">
	...
	function remove(id) {
		if (confirm("确定删除吗！！！")) {
			location.href = "${pageContext.request.contextPath}/mail/modifysign"+"?id="+id+"&sign=1";
		}
	}
</script>
